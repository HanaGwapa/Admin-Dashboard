...
<body>
  ...
  <script>
    const orders = [{
        ...
        buyerAv: 'CE',
        buyerColor: 'av-c1',
        buyerName: 'Crafty Emma (crafty_emma)',
        buyerPhone: '+1 123-456-7890',
        buyerAddr: 'Emma R.<br>123 Handmade Ln<br>Austin, TX 78702<br>United States',
        sellerAv: 'WJ',
        sellerColor: 'av-c3',
        sellerName: 'Woodwonder_Jake',
        sellerPhone: '+1 987-654-3210',
        sellerEmail: 'jake@woodycrafts.com',
        sellerHandle: 'woodwonder_jake',
        prodIcon: '🪵',
        prodName: 'Handmade Wood Coasters',
      ...
      },
      {
        ...
        buyerAv: 'BG',
        buyerColor: 'av-c2',
        buyerName: 'Beads Girl (beads_girl)',
        buyerPhone: '+1 555-234-9981',
        buyerAddr: 'Bea G.<br>47 Blossom Ave<br>Portland, OR 97201<br>United States',
        sellerAv: 'HS',
        sellerColor: 'av-c4',
        sellerName: 'Handmadeby_Sara',
        sellerPhone: '+1 312-887-4521',
        sellerEmail: 'sara@handmade.shop',
        sellerHandle: 'handmadeby_sara',
        prodIcon: '📿',
        prodName: 'Beaded Bracelet Set',
      ...
      },
      {
        ...
        buyerAv: 'AA',
        buyerColor: 'av-c7',
        buyerName: 'Artisan Alex (artisan_alex)',
        buyerPhone: '+1 415-662-3301',
        buyerAddr: 'Alex M.<br>88 Pottery Lane<br>Denver, CO 80205<br>United States',
        sellerAv: 'CC',
        sellerColor: 'av-c5',
        sellerName: 'Clayandcolor',
        sellerPhone: '+1 720-445-1122',
        sellerEmail: 'hello@clayandcolor.com',
        sellerHandle: 'clayandcolor',
        prodIcon: '🏺',
        prodName: 'Hand-Thrown Ceramic Bowl',
      ...
      },
      {
        ...
        buyerAv: 'SS',
        buyerColor: 'av-c5',
        buyerName: 'Student Sam (student_sam)',
        buyerPhone: '+1 628-992-4477',
        buyerAddr: 'Sam T.<br>22 College St<br>Boston, MA 02118<br>United States',
        sellerAv: 'CJ',
        sellerColor: 'av-c2',
        sellerName: 'Crafty_Jenny',
        sellerPhone: '+1 617-342-9900',
        sellerEmail: 'jenny@craftyjenny.co',
        sellerHandle: 'crafty_jenny',
        prodIcon: '🧵',
        prodName: 'Hand-Stitched Tote Bag',
      ...
      },
      {
        ...
        buyerAv: 'MM',
        buyerColor: 'av-c6',
        buyerName: 'Macrame Mia (macrame_mia)',
        buyerPhone: '+1 702-881-3344',
        buyerAddr: 'Mia R.<br>5 Desert Bloom Rd<br>Las Vegas, NV 89101<br>United States',
        sellerAv: 'BK',
        sellerColor: 'av-c3',
        sellerName: 'Beads_and_Knots',
        sellerPhone: '+1 561-773-2200',
        sellerEmail: 'shop@beadsknots.com',
        sellerHandle: 'beads_and_knots',
        prodIcon: '🪢',
        prodName: 'Macrame Wall Hanging',
      ...
      },
      {
        ...
        buyerAv: 'PP',
        buyerColor: 'av-c4',
        buyerName: 'Pottery Pete (potterypete)',
        buyerPhone: '+1 503-221-6680',
      ...
      },
      {
        ...
        buyerAv: 'LW',
        buyerColor: 'av-c7',
        buyerName: 'Leatherwork Ly (leatherwork_ly)',
        buyerPhone: '+1 214-557-8899',
        buyerAddr: 'Ly N.<br>12 Saddle St<br>Dallas, TX 75201<br>United States',
        sellerAv: 'RC',
        sellerColor: 'av-c6',
        sellerName: 'Rustic_Crafts',
        sellerPhone: '+1 940-882-4412',
        sellerEmail: 'info@rusticcrafts.store',
        sellerHandle: 'rustic_crafts',
        prodIcon: '🪑',
        prodName: 'Reclaimed Wood Shelf',
