...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    <a class="nav-item active" href="#"><i class="fa-solid fa-gauge-high"></i> Dashboard</a>
    <a class="nav-item" href="#"><i class="fa-solid fa-box-open"></i> Product Approvals <span class="nav-badge">12</span></a>
    <a class="nav-item" href="#"><i class="fa-solid fa-user-check"></i> Seller Verification</a>
